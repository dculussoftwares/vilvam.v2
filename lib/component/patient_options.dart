...
class PatientOptions extends StatelessWidget {
  const PatientOptions({super.key});
...
//   @override
//   Widget build(BuildContext context) {
//     return const ComponentGroupDecoration(label: 'Patient Options', children: <Widget>[
//       Buttons(),
//     ]);
//   }
// }

class PatientsOptions extends StatefulWidget {
  const PatientsOptions({super.key});

  @override
  State<PatientsOptions> createState() => _PatientsOptionsState();
}

class _PatientsOptionsState extends State<PatientsOptions> {
  @override
  Widget build(BuildContext context) {
...
class HealersOptions extends StatelessWidget {
  const HealersOptions({super.key});
...
class HealeeOptions extends StatelessWidget {
  const HealeeOptions({super.key});

  void openSearchPatientFullscreenDialog(BuildContext context) {
    showDialog<void>(
      context: context,
  ...
  void openAddPatientFullscreenDialog(BuildContext context) {
    showDialog<void>(
      context: context,
      builder: (context) => Dialog.fullscreen(
        child: Padding(
  ...
  Widget build(BuildContext context) {
    return ComponentDecoration(
      label: 'Healee',
      tooltipMessage: 'This sections belongs to healers',
      child: Wrap(
...
class ClinicOptions extends StatelessWidget {
  const ClinicOptions({super.key});

  void openAddClinicFullscreenDialog(BuildContext context) {
    showDialog<void>(
      context: context,
      builder: (context) => Dialog.fullscreen(
        child: Padding(
          ...
          child: Scaffold(
            ...
            body: const Column(
              children: [Text("add clinic"), AddClinicForm()],
            ),
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return ComponentDecoration(
      label: 'Clinic',
      tooltipMessage: 'This sections belongs to healer',
      child: Wrap(
        alignment: WrapAlignment.spaceEvenly,
        children: [
          SizedBox(
...
class DataExportOptions extends StatelessWidget {
  const DataExportOptions({super.key});
